...
const MessageState: FC<Props> = ({
  ...
  return (
    <View className="flex-1 justify-center items-center px-4 bg-white dark:bg-zinc-900">
      <Animated.View entering={FadeInDown} className="items-center mb-2">
        {customIcon && customIcon}
      </Animated.View>

      <Text className="text-xl font-bold text-zinc-800 dark:text-indigo-400 mb-2 text-center">
        {title}
      </Text>
